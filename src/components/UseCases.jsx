...
const UseCases = () => {
  return (
    <div className=' bg-black w-full h-[811.38px] max-[395px]:h-[1700px] max-md:h-[1200px] items-center rounded-[31.25px] flex flex-col overflow-hidden'>
    ...
    <div className='w-full h-fit  px-[40.62px] max-[395px]:px-[20px] gap-[20.31px] flex flex-row max-md:flex-col mb-[20.31px]'>
    <UseCard width='58%' title="eCommerce" description="Use Convioo to tell your founding story, share your vision, or talk
    about what makes you special." image={ecommerce} imgStyle=' w-[159.11px] max-[395px]:w-full h-[80%] overflow-hidden flex items-end justify-center'
    direction="right"
    />
    <UseCard width='42%' title="Outreach" description="A one-size-fits-all solution. Let viewers choose their own journeys."
    image={outreach}
    imgStyle=' w-[159.11px] max-[395px]:w-full h-[80%] overflow-hidden flex items-start justify-center'
    itemAlign="end"
    direction="left"
    />

    </div>
    <div className='w-full h-[208.03px]  px-[40.62px] max-[395px]:px-[20px] gap-[20.31px] flex flex-row max-md:flex-col'>
...
image={marketing}
imgStyle=' w-[159.11px] max-[395px]:w-full h-[100%] overflow-hidden flex items-center justify-center'
itemAlign="center"
direction="right"
...
image={saas}
imgStyle=' w-[235.91px] max-[395px]:w-full h-[142.19px] overflow-hidden flex items-center justify-center'
itemAlign="center"
direction="left"
/>
